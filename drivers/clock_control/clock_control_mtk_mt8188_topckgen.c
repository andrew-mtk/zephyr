...
#include "clock_control_mtk_topckgen_common.h"
 ...
 * return -ENOTSUP.
 */
static int mtk_topckgen_clock_configure(const struct device *dev,
...
DEVICE_DT_INST_DEFINE(0, &mtk_topckgen_init, NULL,
		      &topckgen_data, &topckgen_cfg,
