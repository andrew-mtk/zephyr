...
#ifndef DRIVERS_CLOCK_CONTROL_CLOCK_CONTROL_MTK_TOPCKGEN_COMMON_H
#define DRIVERS_CLOCK_CONTROL_CLOCK_CONTROL_MTK_TOPCKGEN_COMMON_H
...
#endif /* DRIVERS_CLOCK_CONTROL_CLOCK_CONTROL_MTK_TOPCKGEN_COMMON_H */
